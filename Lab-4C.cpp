//Celeste Going
//Lab 4C
/*This program calculates a customer's change by subtracting
the amount entered into the vending machine by the amount
purchased, and then displays the change in a combination of
